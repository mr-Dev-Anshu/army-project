    ...
    return {
      ...
      particulars: {
        primary: {
          ...
          armyNo: primary.armyNo || "",
          rank: primary.rank || "",
          unit: primary.unit || "",
          fmn: primary.fmn || "",
          command: primary.command || "",
          address: primary.address || "",
          iCardNo: primary.iCardNo || "",
        },
        secondary: secondary ? {
          aadharCardNo: secondary.aadharCardNo || "",
          name: secondary.name || "",
          so: secondary.so || "",
          relation: secondary.relation || "",
          armyNo: secondary.armyNo || "",
          rank: secondary.rank || "",
          unit: secondary.unit || "",
          fmn: secondary.fmn || "",
          command: secondary.command || "",
          address: secondary.address || "",
          iCardNo: secondary.iCardNo || "",
        } : undefined,
      ...
      occurrence: {
        ...
        dutyTime: mpDetails.dutyTime || "",
        dutyLocation: mpDetails.placeOfDuty || "",
        nameOfWitnessingOfficial1: witness.name || "",
        ...
        locationOfOffence: occDetails.incidentLocation || "",
        statement: occDetails.statement || "",
      },
      offence: {
        type: offence.currentOffenceType || "",
      ...
      mpSig: {
        armyNo: mpDetails.armyNoReportingMP || "",
        rank: mpDetails.rank || "",
        name: mpDetails.nameReportingMP || "",
        unit: mpDetails.unit || "",
      },
      remarks: {
