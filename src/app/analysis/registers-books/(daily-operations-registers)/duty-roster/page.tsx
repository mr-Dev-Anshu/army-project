...
import DutyRosterTable from "@/features/RegisterBooks/DailyOperationsRegisters/dutyRoster/components/dutyRosterTable";
import RightSideSheet from "@/components/common/RightSideSheet";
import { useGetDutyRosterRegisters, useDeleteDutyRosterRegister } from "@/features/RegisterBooks/DailyOperationsRegisters/dutyRoster/hooks";
...
const Page = () => {
    ...
    // Fetch data
    const { data: registers = [], isLoading } = useGetDutyRosterRegisters();
    const deleteMutation = useDeleteDutyRosterRegister();
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <RightSideSheet
                ...
                title={selectedRecord ? "Edit Duty Roster Entry" : "Add Duty Roster Entry"}
                description="Record daily duty roster details"
            >
                <DutyRosterForm
