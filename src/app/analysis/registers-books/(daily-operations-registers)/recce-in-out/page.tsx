...
import RecceInOutTable from "@/features/RegisterBooks/DailyOperationsRegisters/recceInOut/components/recceInOutTable";
import RightSideSheet from "@/components/common/RightSideSheet";
import { useGetRecceInOutRegisters, useDeleteRecceInOutRegister } from "@/features/RegisterBooks/DailyOperationsRegisters/recceInOut/hooks";
...
const Page = () => {
    ...
    // Fetch data
    const { data: registers = [], isLoading } = useGetRecceInOutRegisters();
    const deleteMutation = useDeleteRecceInOutRegister();
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <RightSideSheet
                ...
                title={selectedRecord ? "Edit Recce Out Entry" : "Add Recce Out Entry"}
                description="Record Recce departure details"
            >
                <RecceInOutForm
