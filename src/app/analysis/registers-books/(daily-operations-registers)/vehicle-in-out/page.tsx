...
import VehicleInOutTable from "@/features/RegisterBooks/DailyOperationsRegisters/vehicleInOut/components/vehicleInOutTable";
import RightSideSheet from "@/components/common/RightSideSheet";
import { useGetVehicleInOutRegisters, useDeleteVehicleInOutRegister } from "@/features/RegisterBooks/DailyOperationsRegisters/vehicleInOut/hooks";
...
const Page = () => {
    ...
    // Fetch data
    const { data: registers = [], isLoading } = useGetVehicleInOutRegisters();
    const deleteMutation = useDeleteVehicleInOutRegister();
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <RightSideSheet
                ...
                title={selectedRecord ? "Edit Vehicle Out Entry" : "Add Vehicle Out Entry"}
                description="Record Vehicle departure details"
            >
                <VehicleInOutForm
