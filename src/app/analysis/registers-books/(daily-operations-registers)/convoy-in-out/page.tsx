...
import ConvoyInOutTable from "@/features/RegisterBooks/DailyOperationsRegisters/convoyInOut/components/convoyInOutTable";
import RightSideSheet from "@/components/common/RightSideSheet";
import { useGetConvoyRegisters, useDeleteConvoyRegister } from "@/features/RegisterBooks/DailyOperationsRegisters/convoyInOut/hooks";
...
const Page = () => {
    ...
    // Fetch data
    const { data: registers = [], isLoading } = useGetConvoyRegisters();
    const deleteMutation = useDeleteConvoyRegister();
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <RightSideSheet
                ...
                title={selectedRecord ? "Edit Convoy Out Entry" : "Add Convoy Out Entry"}
                description="Record Convoy departure details"
            >
                <ConvoyInOutForm
