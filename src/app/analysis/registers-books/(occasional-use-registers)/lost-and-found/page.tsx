...
import LostAndFoundTable from "@/features/RegisterBooks/OccasionalUseRegisters/lostAndFound/components/lostAndFoundTable";
import RightSideSheet from "@/components/common/RightSideSheet";
import { useGetLostAndFoundRegisters, useDeleteLostAndFoundRegister } from "@/features/RegisterBooks/OccasionalUseRegisters/lostAndFound/hooks";
...
const Page = () => {
    ...
    // Fetch data
    const { data: registers = [], isLoading } = useGetLostAndFoundRegisters();
    const deleteMutation = useDeleteLostAndFoundRegister();
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <RightSideSheet
                ...
                title={selectedRecord ? "Edit Lost & Found Entry" : "Add Lost & Found Entry"}
                description="Record found / deposited item"
            >
                <LostAndFoundForm
