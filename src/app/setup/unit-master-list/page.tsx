...
import UnitMasterListTable from "@/features/unitMasterList/components/unitMasterListTable";
import RightSideSheet from "@/components/common/RightSideSheet";
import UnitMasterListForm from "@/features/unitMasterList/components/form";
import { UnitMasterList } from "@/apis/unitMasterList/types";

const UnitMasterListView = () => {
    const [isAddOpen, setIsAddOpen] = useState(false);
    const [editingUnit, setEditingUnit] = useState<UnitMasterList | null>(null);
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <RightSideSheet
                ...
                description={editingUnit ? "Update details to modify unit" : "Fill details to create new unit"}
                className="w-[800px] sm:w-[900px]"
            >
                <UnitMasterListForm
                    onCancel={() => {
                        setIsAddOpen(false);
...
export default UnitMasterListView;
