...
const CivilEmployeeMenu = () => {
    const cards = [
        {
            title: "Shopkeepers & Workers Security Passes",
            icon: <ShoppingCart className="w-8 h-8 text-white" />,
            href: "/setup/civil-employees/shopkeeper",
        },
        {
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {cards.map((card, index) => (
                        <Link
                            key={index}
                            href={card.href}
                            className="group cursor-pointer rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:shadow-md active:scale-[0.98] block"
                        >
...
export default CivilEmployeeMenu;
