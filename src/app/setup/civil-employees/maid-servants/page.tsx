...
import MaidServantTable from "@/features/civilEmployee/maid_Servant/component/MaidServantTable";
import RightSideSheet from "@/components/common/RightSideSheet";
import MaidServantSecurityPassEntryForm from "@/features/civilEmployee/maid_Servant/component/form";

const MaidServantView = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <RightSideSheet
                ...
                title={editingMaidServant ? "Edit Maid Servant Pass" : "Add Maid Servant Pass"}
                description={editingMaidServant ? "Update details to modify maid servant pass" : "Fill details to generate maid servant pass"}
            >
...
export default MaidServantView;
