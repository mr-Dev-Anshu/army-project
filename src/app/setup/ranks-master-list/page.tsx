...
import RankMasterListTable from "@/features/rankMasterList/components/rankMasterListTable";
import RightSideSheet from "@/components/common/RightSideSheet";
import RankMasterListForm from "@/features/rankMasterList/components/form";
import { RankMasterList } from "@/apis/rankMasterList/types";

const RankMasterListView = () => {
    const [isAddOpen, setIsAddOpen] = useState(false);
    const [editingRank, setEditingRank] = useState<RankMasterList | null>(null);
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <RightSideSheet
                ...
                description={editingRank ? "Update details to modify rank" : "Fill details to create new rank"}
            >
                <RankMasterListForm
                    onCancel={() => {
                        setIsAddOpen(false);
...
export default RankMasterListView;
