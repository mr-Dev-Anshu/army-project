...
export const generateMPOccurrenceWordReport = async (
  data: MpOccurrenceReportProps
) => {
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({ text: "RESTRICTED", bold: true, underline: {} }),
            ],
          }),
          new Paragraph({
            alignment: AlignmentType.RIGHT,
            children: [
              new TextRun({ text: "IAFP-1479 (Revised)", bold: true }),
            ],
            spacing: { after: 200 },
          }),
          new Paragraph({
            ...
            children: [
              new TextRun({
                text: "MP OCCURRENCE & INVESTIGATION REPORT",
                bold: true,
                underline: {},
                size: 24,
              }),
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "(MP must caution witness and ensure presence of independent witness if possible)",
                size: 16,
              }),
            ],
            spacing: { after: 200 },
          ...
          createSectionHeader(
            "5.",
            "WITNESS:",
            "(Witness must record statement in own hand where possible)"
          ),
          ...
          createSectionHeader(
            "6.",
            "EVIDENCE:",
            "(Collect and record evidence carefully)"
          ),
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "DETAILED OCCURRENCE REPORT",
                bold: true,
                underline: {},
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "POINTS FIND OUT DURING THE INVESTIGATION",
                bold: true,
                underline: {},
              }),
            ],
          ...
          ...data.detailedReport.findings.map(
            (f) =>
              new Paragraph({
                bullet: { level: 0 },
          ...
          new Paragraph({
            children: [
              new TextRun({ text: "OPINION:", bold: true, underline: {} }),
            ],
            spacing: { after: 200 },
          }),
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "REMARKS CO/2IC PROVOST UNIT",
                bold: true,
                underline: {},
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: "Check evidence gives analysis and recommendation and fill IAFP-901 if required",
                size: 16,
              }),
            ],
            alignment: AlignmentType.CENTER,
          ...
          new Paragraph({
            children: [
              new TextRun({ text: "ANALYSIS-", bold: true, underline: {} }),
            ],
            spacing: { after: 200 },
          }),
          new Paragraph({
                  ...
                  new TableCell({
                    children: [
                      new Paragraph({
                        children: [
                          new TextRun({
                            text: "(Signature of CO/2IC with unit seal)",
                            bold: true,
                          }),
                        ],
                        alignment: AlignmentType.CENTER,
        ...
        children: [
            ...
            children: [
              new Paragraph({
                children: [
                  ...
                  new TextRun(data.reportNo),
                ],
              }),
              new Paragraph({
                children: [
                  new TextRun({
                    text: "(Fill in Desk Room)",
                    size: 16,
                    color: "666666",
                  }),
                ],
            ...
            children: [
              new Paragraph({
                children: [
                  ...
                  new TextRun(data.command),
                ],
                alignment: AlignmentType.CENTER,
              }),
              new Paragraph({
                children: [
                  new TextRun({ text: "(Origin)", size: 16, color: "666666" }),
                ],
                alignment: AlignmentType.CENTER,
              }),
            ],
          ...
          new TableCell({
            children: [
              new Paragraph({
                children: [
                  new TextRun({ text: "FIR No.- ", bold: true }),
                  new TextRun(data.firNo),
                ],
                alignment: AlignmentType.RIGHT,
              }),
              new Paragraph({
    ...
    children: [
      new TableCell({
        children: [
          new Paragraph({
            alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: "Sno.", bold: true })],
          }),
        ],
      ...
      new TableCell({
        children: [
          new Paragraph({
            children: [
              new TextRun({ text: "Army No., Rank & Name", bold: true }),
            ],
          }),
        ],
      ...
      new TableCell({
        children: [
          new Paragraph({
            children: [new TextRun({ text: "Identity Card", bold: true })],
          }),
        ],
      ...
      new TableCell({
        children: [
          new Paragraph({
            children: [new TextRun({ text: "Unit/Tele No.", bold: true })],
          }),
        ],
        ...
        children: [
          ...
          new TableCell({
            children: [
              new Paragraph({
                children: [
                  new TextRun({ text: "Army no.: ", bold: true }),
                  new TextRun(p.armyNo),
                ],
              }),
              new Paragraph({
                children: [
          ...
          new TableCell({
            children: [new Paragraph(p.identityCard)],
            verticalAlign: VerticalAlign.CENTER,
          }),
          new TableCell({
            children: [
              new Paragraph({
                children: [
                  ...
                  new TextRun(p.unitName),
                ],
              }),
              new Paragraph({
                children: [
                  new TextRun({ text: "FMN: ", bold: true }),
                  new TextRun(p.fmn),
                ],
              }),
              new Paragraph({
                children: [
                  ...
                  new TextRun(p.address),
                ],
              }),
            ],
          }),
          new TableCell({
            children: [new Paragraph(p.remark)],
            verticalAlign: VerticalAlign.CENTER,
          }),
        ],
      })
  ...
  if (people.length === 0) {
    rows.push(
      new TableRow({
        children: [
          new TableCell({
            children: [new Paragraph("No details available")],
            columnSpan: 5,
          }),
        ],
      })
        ...
        children: [
          new TableCell({
            children: [
              new Paragraph({
                children: [
                  new TextRun({ text: "Eye Sketch- ", bold: true }),
                  new TextRun(evidence.eyeSketch),
                ],
              }),
              createUnderline(),
            ],
          ...
          new TableCell({
            children: [
              new Paragraph({
                children: [
                  new TextRun({ text: "Photos- ", bold: true }),
                  new TextRun(evidence.photos),
                ],
              }),
              createUnderline(),
            ],
          ...
          new TableCell({
            children: [
              new Paragraph({
                children: [
                  new TextRun({ text: "Videos- ", bold: true }),
                  new TextRun(evidence.videos),
                ],
              }),
              createUnderline(),
            ],
