...
export const RightPanel = ({
  ...
  return (
    <div className="flex-1 h-full p-4 sm:p-6 lg:p-8 flex flex-col w-full overflow-hidden">
      {/* ---------- HEADER ---------- */}
      ...
      {/* ---------- CONTENT ---------- */}
      <div className="border rounded-lg p-4 sm:p-5 lg:px-6 mb-4 sm:mb-6 overflow-y-auto max-h-[60vh] sm:max-h-[70vh] lg:max-h-none">
        {current?.component || <p>Step Content Coming Soon...</p>}
      </div>
      ...
      <div className="mt-auto flex flex-col sm:flex-row justify-end gap-2">
        ...
        {isLastStep && (
          <Button className="bg-blue-600 w-full sm:w-auto" onClick={onSubmitFinal}>
            Submit & Create Offence
          </Button>
        )}
      </div>
