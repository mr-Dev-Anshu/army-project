...
interface Step4RemarksProps {
  ...
  files?: string[];
  attachments?: AttachmentItem[]; // New prop
...
export default function Step4Remarks({
  ...
  return (
    <div className="space-y-6 px-1">
      ...
      {/* LEGACY FILE LIST (Keep for backward compatibility if needed) */}
      {/* 
      {files.length > 0 && (
         <div className="space-y-2 mt-4 pt-4 border-t">
             <Label className="font-semibold text-sm text-gray-700">Legcay Uploads</Label>
             <FileUpload
               value={files}
