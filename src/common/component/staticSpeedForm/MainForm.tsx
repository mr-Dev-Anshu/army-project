...
//         if (person.id) {
//           console.log("UPDATING OFFENDER WITH ID 👉", person.id) ;
//           // ✅ UPDATE EXISTING OFFENDER
//           await updateOffender(person.id, {
...
//           armyNumber: w.reportingBlock.armyNumber,
//           nameReportingMP: w.reportingBlock.nameReportingMP,
