...
export default function CivilianWithDependent({
  ...
  useEffect(() => {
    ...
    if (showCoDriver && (scope === "traffic" || scope === "static")) {
      ...
      if (Array.isArray(list)) {
        const coDriverIdx = list.findIndex(
  ...
  return (
    <div className="space-y-4">
      ...
      <OffenderDynamicForm
        title={customTitle || "Civilian Details"}
            ...
            <div className="mt-4">
              <div className="mb-4">
                ...
                <p className="text-sm text-gray-500">
                  Select who the offender is and fill their details. The form
                  will update based on your selection.
                </p>
              </div>
              <OffenderDynamicForm
                title=""
      ...
      {showCoDriver && (
        <div className="mt-6 pt-4 border-t">
          <div className="flex items-center gap-2">
            ...
            >
              Was there a <b>Co-Driver or Pillion Rider</b> with the
              driver/rider?
            </label>
          </div>
