...
const Sidebar = () => {
  ...
  const createNewRecordItems = [
    {
      ...
      label: (
        <>
          <span className="font-bold">General & Traffic</span> Offence Report
        </>
      ),
    ...
    },
    {
      ...
      label: (
        <>
          MP Occurrence & <span className="font-bold">Investigation</span>{" "}
          Report
        </>
      ),
  ...
  const reportsAndAnalysis = [
    ...
    },
    {
      ...
      label: (
        <>
          MP Offence <span className="font-bold">Analysis</span> Monthly{" "}
      ...
      submenu: [
        {
          label: (
            <>
              <span className="font-bold">Offence Types</span> Management
            </>
          ),
        ...
        },
        {
          label: (
            <>
              <span className="font-bold">Civil Employees</span> Managemen
            </>
          ),
        ...
        },
        {
          label: (
            <>
              <span className="font-bold">Vehicles Security Pass</span>{" "}
              Management
            </>
          ),
