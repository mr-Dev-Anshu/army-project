...
export const ImmediateReportingIncidentForm: React.FC<Props> = ({ onCancel, onSuccess, initialData }) => {
    ...
    const updateIndividual = (index: number, field: string, value: any) => {
        ...
        // Fields that belong to individualDetails
        const detailFields = ['armyNo', 'rank', 'name', 'unit', 'fmn'];

        if (detailFields.includes(field)) {
            currentInd.individualDetails = {
                ...currentInd.individualDetails,
                [field]: value
            };
        } else {
            currentInd[field] = value;
        }
            ...
            <div className="space-y-8 flex-1 overflow-y-auto pb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <SuggestionInput
                                        ...
                                        value={individual.individualDetails?.armyNo || ""}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <SuggestionInput
                                        ...
                                        value={individual.individualDetails?.rank || ""}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <SuggestionInput
                                        ...
                                        value={individual.individualDetails?.name || ""}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                                <div className="space-y-2">
                                    ...
                                    <SuggestionInput
                                        ...
                                        value={individual.individualDetails?.unit || ""}
                            ...
                            <div className="grid grid-cols-1 gap-6 mt-6">
                                <div className="space-y-2">
                                    ...
                                    <SuggestionInput
                                        ...
                                        value={individual.individualDetails?.fmn || ""}
                ...
                <div className="grid grid-cols-1 gap-6 pl-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <Label>Time of Occurrence (24hr format)</Label>
                            <Input
                                type="time"
