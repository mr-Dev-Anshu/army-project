    ...
    return (
        <div className="mx-auto w-full max-w-4xl rounded-xl bg-white shadow-sm border border-neutral-200 overflow-hidden font-inter">
            ...
            <div className="flex items-center justify-between border-b border-neutral-100 px-6 py-4">
                <div>
                    <h2 className="text-lg font-bold text-neutral-900">
                        Add Mobile Phone Out Entry
                    </h2>
                    <p className="text-sm text-neutral-500">
                        Record Mobile Phone departure details
                    </p>
                </div>
            ...
            <div className="p-6 space-y-8">
                {/* Mobile Phone OUT Details */}
                <section className="space-y-4">
                    <h3 className="text-sm font-bold text-neutral-900">Mobile Phone OUT Details</h3>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="space-y-1.5">
                            <Label htmlFor="mobilePhoneOutTime" className="text-xs font-medium text-neutral-700">
                ...
                {/* Mobile Phone IN Details */}
                <section className="space-y-4 pt-4 border-t border-neutral-100">
                    <h3 className="text-sm font-bold text-neutral-900">Mobile Phone IN Details</h3>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div className="space-y-1.5">
                            <Label htmlFor="mobilePhoneInTime" className="text-xs font-medium text-neutral-700">
