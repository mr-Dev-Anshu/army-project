              ...
              {data.hasMilitaryRelative && (
                <>
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(v) =>
                      onChange("militaryRelative", {
                        ...(data.militaryRelative || {}),
                        individualType: v,
                        individualDetails:
                          data.militaryRelative?.individualDetails || {},
                      })
                    }
          ...
          <div className="relative border-t rounded-lg p-4 space-y-4">
            ...
            {data.isVehicleInvolved && (
              <div className="space-y-4">
                ...
                <div>
                  <Label className="pb-2">Registration No.</Label>
                  <Input
                ...
                {/* ✅ MAKE & TYPE */}
                <div>
                  <Label className="pb-2">Make & Type</Label>
                  <Input
                    placeholder="eg. Gypsy / Truck / Car"
                    value={data.vehicleMakeType || ""}
                    onChange={(e) =>
                      onChange("vehicleMakeType", e.target.value)
                    }
                  />
                </div>
