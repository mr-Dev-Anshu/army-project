...
export function DynamicTable<T>({
  ...
  return (
    <div className={cn("overflow-x-auto overflow-y-auto max-h-[350px] rounded-lg border border-gray-200 bg-white [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]", className)}>
