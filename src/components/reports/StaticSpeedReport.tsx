            ...
            <div className="max-w-[210mm] w-full mx-auto bg-white p-[48px] min-h-[297mm] shadow-lg print:shadow-none print:min-h-0 relative flex flex-col print:p-[48px]" style={{ pageBreakAfter: 'always' }}>
                ...
                <div className="flex flex-col mb-8">
                    ...
                    <div className="flex justify-between items-end text-xs">
                        {reportNo && <div><span className="font-bold">Report No-</span> {reportNo}</div>}
                        {unitName && <div><span className="font-bold">Unit:</span> {unitName}</div>}
                        {reportDate && <div><span className="font-bold">Report Date-</span> {reportDate}</div>}
                    </div>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="border border-gray-300 mb-6 text-xs">
                        ...
                        {/* (2.2) Witness 1 */}
                        {(occurrence.nameOfWitnessingOfficial1 || occurrence.rankOfWitnessingOfficial1) && (
                            <div className="grid grid-cols-2 border-b border-gray-300">
                                <div className="p-2 pl-4 grid grid-cols-[45px_110px_1fr] items-center">
                                    <span>(2.2)</span>
                        ...
                        {/* (2.2.1) Witness 2 */}
                        {(occurrence.nameOfWitnessingOfficial2 || occurrence.rankOfWitnessingOfficial2) && (
                ...
                <div className="mb-8">
                    ...
                    <div className="ml-4 grid grid-cols-[40px_1fr] gap-y-2 text-xs">
                        ...
                        <div className="flex flex-col gap-y-2">
                            <DataField label="Actual Speed Noted" value={offence.actualSpeed} className="grid-cols-[200px_1fr]" />
                            <DataField label="Auth Speed" value={offence.authSpeed} className="grid-cols-[200px_1fr]" />
                            <DataField label="Over Speed Calculated" value={offence.overSpeed} className="grid-cols-[200px_1fr]" />
                        </div>
                    </div>
                </div>
                    ...
                    <div className="flex justify-between items-start text-xs ml-6">
                        <div className="max-w-[45%]">
                            ...
                            <div className="flex flex-col gap-y-1">
                                <DataField label="Army No." value={witnessSig.armyNo} className="grid-cols-[70px_1fr]" />
                                <DataField label="Rank" value={witnessSig.rank} className="grid-cols-[70px_1fr]" />
                                <DataField label="Name" value={witnessSig.name} className="grid-cols-[70px_1fr]" />
                                <DataField label="Unit" value={witnessSig.unit} className="grid-cols-[70px_1fr]" />
                            </div>
                        </div>
                        <div className="max-w-[45%]">
                            <div className="font-bold mb-4 text-left">Sig of MP JCO/NCO</div>
                            <div className="flex flex-col gap-y-1">
                                <DataField label="Army No." value={mpSig.armyNo} className="grid-cols-[70px_1fr]" />
                                <DataField label="Rank" value={mpSig.rank} className="grid-cols-[70px_1fr]" />
                                <DataField label="Name" value={mpSig.name} className="grid-cols-[70px_1fr]" />
                                <DataField label="Unit" value={mpSig.unit} className="grid-cols-[70px_1fr]" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="pt-4 flex-1 text-xs">
                    ...
                    <div className="grid grid-cols-[80px_1fr] gap-y-2">
                        <DataField label="Station :" value={remarks.station} className="grid-cols-[80px_1fr]" />
                        <DataField label="Dated :" value={remarks.dated} className="grid-cols-[80px_1fr]" />
                    </div>
                </div>
            </div>
        </div>
